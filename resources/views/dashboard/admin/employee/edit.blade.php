...
<html lang="en">
  <head>
    ...
    <title>Edit Employee - PetDKI</title>
  ...
  <body class="bg-white min-h-screen">
    <div class="pt-10 px-0 md:pt-16 md:pr-16 bg-white flex flex-col lg:flex-row">
      <!-- Sidebar -->
      ...
      <main class="w-full lg:w-[73%] lg:ml-5 mt-10 lg:mt-0">
        <div class="flex flex-col items-start w-full">
          ...
          <!-- Add Employee Form -->
          <form class="w-full">
            <h2 class="mt-20 text-4xl font-bold text-blue-950 max-md:mt-10">Edit Employee</h2>
