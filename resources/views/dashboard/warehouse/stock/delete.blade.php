...
<body class="bg-white text-slate-600">
  ...
  <div class="flex items-center gap-4">
    ...
    <!-- Delete Modal -->
    <div
        class="flex fixed top-0 left-0 justify-center items-center backdrop-blur-[7.5px] bg-opacity-40 size-full"
      >
        <div
        ...
        >
          ...
          <div class="mt-32">
            ...
            <p class="mb-9 text-2xl text-slate-600">
              <span>This will delete your product from your stock</span>
              <br />
