    ...
    <section class="py-2 ml-5 max-md:ml-0 max-md:w-full">
        <div class="w-full font-medium max-md:max-w-full">
            ...
            <div class="flex flex-wrap gap-5 justify-between w-full font-bold max-md:max-w-full">
                <h2 class="my-auto text-4xl text-blue-950">Edit Penyesuaian Stok</h2>
                ...
                <form action="{{ route('warehouse.stockadj.update', $adjustment->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="adjustment_type" id="adjustment_type" class="form-input" required>
                            ...
                            <option value="in" {{ $adjustment->adjustment_type == 'in' ? 'selected' : '' }}>
                                Penambahan
                            </option>
                            <option value="out" {{ $adjustment->adjustment_type == 'out' ? 'selected' : '' }}>
                                Pengurangan
                            </option>
                        </select>
