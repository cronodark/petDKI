...
<html lang="en">
  <head>
    ...
    <title>Edit Category - PetDKI Admin</title>
...
"
  ...
  <label
    for="category-name"
    class="mt-20 text-xl font-medium text-zinc-400 block max-md:mt-10"
  >
    Category Name
  </label>
  ...
  <button
    type="submit"
    class="px-3.5 py-7 mt-8 text-xl font-bold text-white rounded-2xl bg-slate-600"
  >
    Edit Category
  </button>
</form>
