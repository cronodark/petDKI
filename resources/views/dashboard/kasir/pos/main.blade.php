...
<html lang="en">
  <head>
    ...
    <title>POS Transaction Detail</title>
          ...
          <section class="lg:w-[36%] w-full">
            <article class="flex flex-col grow pt-5 pb-24 w-full bg-white shadow-sm rounded-lg">
              ...
              <div class="mt-6 px-4 sm:px-6 md:px-8">
                <button
                  class="w-full py-3 text-white text-lg sm:text-xl font-semibold bg-slate-600 hover:bg-blue-800 transition-colors duration-300 rounded-lg shadow-md"
                >
                  Pay Now
                </button>
              </div>
