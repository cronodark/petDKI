...
<footer class="bg-gray-100 py-6">
    <div class="max-w-6xl mx-auto px-6 md:flex md:justify-between md:items-center">
        <!-- Logo -->
        <div class="mb-6 md:mb-0">
            <h2 class="text-5xl font-bold text-[#37496A]"> Pet <span class="text-[#37496A]">DKI</span></h2>
        </div>
