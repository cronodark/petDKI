        ...
        <div class="flex justify-between items-center h-16 px-15 pt-5 w-full">
            ...
            <div class="w-1/4 flex justify-end">
                <div class="flex shrink gap-5 basis-auto grow-0 text-slate-600">
                    <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/b08577e4bd3b5d02a7a299862de11ab76c30ca9d07f81f99bd859ec74bdf63b2?placeholderIfAbsent=true&apiKey=bb7eb43fa3b041eb9b0e12445d776380"
                        class="object-contain shrink-0 rounded-full aspect-square w-[59px]" alt="Admin avatar" />
                    <div class="flex flex-col self-start mt-1">
                        <div class="self-start text-xl font-bold">Admin</div>
                        <div class="text-base">LoremIpsum@gmail.com</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div
                    ...
                    <div class="w-full">
                        ...
                        <div class="nav-item w-full">
                            <a href="#"
                                class="flex gap-6 self-stretch ps-8 py-3.5 text-2xl font-medium whitespace-nowrap bg-transparent rounded-[30px_0px_0px_30px] text-white hover:bg-slate-500 transition nav-link active">
