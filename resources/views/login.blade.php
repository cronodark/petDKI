...
@section('content')
    <link href="https://fonts.googleapis.com/css2?family=Paytone+One&family=Montserrat:wght@400;500;700&display=swap"
        rel="stylesheet" />
    <main class="flex w-full h-screen bg-white min-h-[720px] max-md:flex-col">
        <!-- Background Section -->
        <section class="relative max-w-[1280px] max-md:w-full max-md:h-[300px] max-sm:h-[200px]">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/e3c860a263c834a46500108bd471e7f1653f0eed"
                alt="Background" class="object-cover rounded-none size-full max-md:rounded-none" />
            <h1
        ...
        <section class="flex flex-1 justify-center items-center">
            <div class="p-5 w-[500px] max-md:px-3 max-md:py-20 max-md:w-full max-md:max-w-[500px]">
                <h2
                ...
                <form action="{{ route('auth') }}" method="POST" class="flex flex-col gap-6">
                    ...
                    <!-- Username Input -->
                    <input type="text" id="identifier" name="identifier" placeholder="Username/Email"
